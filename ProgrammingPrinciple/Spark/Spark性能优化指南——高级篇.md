...
转载自：https://tech.meituan.com/spark-tuning-pro.html

# 前言

继[基础篇](http://tech.meituan.com/spark-tuning-basic.html)讲解了每个Spark开发人员都必须熟知的开发调优与资源调优之后，本文作为《Spark性能优化指南》的高级篇，将深入分析数据倾斜调优与shuffle调优，以解决更加棘手的性能问题。
...
![img](assets/shuffle-skwed-web-ui-demo.png)
...
![img](assets/shuffle-skwed-add-partition.png)
...
![img](assets/shuffle-skwed-two-phase-aggr.png)
...
![img](assets/shuffle-skwed-map-join.png)
...
![img](assets/shuffle-skwed-sample-expand.png)
...
![img](assets/hash-shuffle-common.png)
...
![img](assets/hash-shuffle-consolidate.png)
...
![img](assets/sort-shuffle-common.png)
...
![img](assets/sort-shuffle-bypass.png)
